function checkAnswer() {
  ...
  if(document.getElementById) {
    ...
    document.getElementById('correct').className = "invis";
    document.getElementById('higher').className = "invis";
    document.getElementById('lower').className = "invis";

    var thenum = document.getElementById('input1').value

    if (((thenum / thenum) != 1) && (thenum != 0)) {
    alert('Por favor, introduza apenas um numero na caixa de edicao');
    ...
    if(document.getElementById('input1').value > 6) {
      // If too high, change classname of 'lower' to make it visible, reset form and focus.
      document.getElementById('lower').className = "lower";
      document.getElementById('input1').value = '';
      var timer = setTimeout("document.getElementById('ex2').input1.focus()",20);
    }
    else if(document.getElementById('input1').value < 6) {
      // If to low, change classname of 'higher' to make it visible, reset form and focus.
      document.getElementById('higher').className = "higher";
      document.getElementById('input1').value = '';
      var timer = setTimeout("document.getElementById('ex2').input1.focus()",20);
    }
    else {
...
function validate()
{
input_box=confirm('Tem a certeza que o seu nome é ' + document.getElementById('yourname').value);
if (input_box==true)
{
// Output when OK is clicked
alert ('O seu nome é ' + document.getElementById('yourname').value);
}
else
{
// Output when Cancel is clicked
alert ('Introduza o seu nome correctamente');
