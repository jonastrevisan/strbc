 ...
 * Example Usage:
 * 
 * var filters = Ext.create('Ext.ux.grid.GridFilters', { ... filters: [{ // required configs type: 'date', dataIndex: 'dateAdded', // optional configs dateFormat: 'm/d/Y', // default beforeText:
 * 'Before', // default afterText: 'After', // default onText: 'On', // default pickerOpts: { // any DatePicker configs },
 * 
...
Ext.define('Ext.ux.grid.filter.DateFilter', {
    ...
    beforeText : 'Before',
    /**
	 * @cfg {Object} compareMap Map for assigning the comparison values used in serialization.
	 */
    compareMap : {
        before : 'lt',
        after : 'gt',
    ...
    /**
	 * @cfg {String} dateFormat The date format to return when using getValue. Defaults to 'm/d/Y'.
	 */
    dateFormat : 'm/d/Y',

    /**
	 * @cfg {Date} maxDate Allowable date as passed to the Ext.DatePicker Defaults to undefined.
	 */
    /**
	 * @cfg {Date} minDate Allowable date as passed to the Ext.DatePicker Defaults to undefined.
	 */
    /**
    ...
    /**
	 * @cfg {Object} menuItemCfgs Default configuration options for each menu item
	 */
    menuItemCfgs : {
        selectOnFocus : true,
        width : 125
    ...
    /**
	 * @cfg {Object} pickerOpts Configuration options for the date picker associated with each field.
	 */
    pickerOpts : {},
    ...
    /**
	 * Template method that is to return <tt>true</tt> if the filter has enough configuration information to be activated.
	 * 
	 * @return {Boolean}
	 */
    ...
    validateRecord : function(record) {
	    var key = 0, pickerValue, val = record.get(this.dataIndex), clearTime = Ext.Date.clearTime;
