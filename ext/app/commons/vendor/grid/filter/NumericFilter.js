 ...
 * 
 * <p>
 * Any of the configuration options for {@link Ext.ux.grid.menu.RangeMenu} can also be specified as configurations to NumericFilter, and will be copied over to the internal menu instance
 * automatically.
 * </p>
 */
Ext.define('Ext.ux.grid.filter.NumericFilter', {
    ...
    isActivatable : function() {
	    var values = this.getValue(), key = 0;
	    for (key in values) {
    ...
    getSerialArgs : function() {
	    var key = 0, args = [], values = this.menu.getValue();
	    for (key in values) {
		    args.push({
		        type : 'numeric',
		        comparison : key,
