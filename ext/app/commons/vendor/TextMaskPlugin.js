 ...
 *	})
 * 
 * Temos a funÃ§Ã£o setMask(mascara) que serve para mudar a mascara
 * depois que o objeto jÃ¡ estiver criado.
 **/
...
Ext.define('Ext.ux.TextMaskPlugin',
{
	...
	{
		if(this.money){
			this.inputEl.setStyle('text-align', 'left');//alinhamento dos valores
		}
 ...
 *   //NÃ£o precisamos definir nada, o componente mascara de acordo com o formato
 *   //da data que jÃ¡ estÃ¡ definido no componente.
 * }) 
 *
...
Ext.define('Ext.ux.form.MaskDateField', {
	...
	//CorreÃ§Ã£o de bug, sÃ³ dava parse na mascara se fosse um TAB
	onFocus2: function(){
 ...
 * isto ocorre sobreescrevendo o xtype do datefield normal, faÃ§o isso pq uso
 * sÃ³mente xtypes no meu sistema, caso nÃ£o queira isto apague a linha abaixo.
 **/
