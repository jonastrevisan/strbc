...

  {
...

	{
...

		{
			...
			die ("<center>Erro na inclusão " . '<br>Linha: ' . __LINE__ . "<br>" . mysql_error() . "<br>
				...
				<a href='../view/index.php'>Voltar ao Menu</a></center>");

		}else{

			print "<script>location='../view/index.php';</script>";
...

	{
...

		{
			...
			echo "<center>Registro Atualizado com Sucesso!<br><a href='../view/index.php'>Voltar ao Menu</a></center>";
...

	{
	  ...
	  if ($regs > 0){
...

		{
			...
			print "<center>Registro Excluído com Sucesso!<br><a href='../view/index.php'>Voltar ao Menu</a></center>";

		}

	  }else{

			print "<center>Registro Não encontrado!<br><a href='../view/index.php'>Voltar ao Menu</a></center>";
